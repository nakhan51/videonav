...
out = cv2.VideoWriter('sensor_video/detection_sensor.avi',fourcc, 20, (frame_width,frame_height))
        ...
        if circles_red is not None:
           for circles in circles_red[0]:
              ...
              if bottom > 70 or right > 70 or upper > 70 or left > 70:
                 cv2.circle(org_image, (x_c, y_c), r, (0, 0, 255), 3)
                 cv2.circle(org_image, (x_c, y_c), 1, (0, 255, 0), 1)
                 cv2.putText(org_image,"red don't go",(int(x_c+10), int(y_c+10)),cv2.FONT_HERSHEY_SIMPLEX,0.5, (15, 15, 15), 2)
